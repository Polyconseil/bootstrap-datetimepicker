  ...
  Datetimepicker.prototype = {
    ...
    setStartDate: function (startDate) {
      ...
      if (this.startDate !== -Infinity) {
        this.startDate = DPGlobal.parseDate(this.startDate, this.format, this.momentFormat, this.language, this.formatType);
      }
      this.update();
    ...
    setEndDate: function (endDate) {
      ...
      if (this.endDate !== Infinity) {
        this.endDate = DPGlobal.parseDate(this.endDate, this.format, this.momentFormat, this.language, this.formatType);
      }
      this.update();
      this.updateNavArrows();
    },
